...
import { cosineSimilarity, findTopKSimilar, extractRelevantSnippet } from './vector-search.js';
...
describe('extractRelevantSnippet', () => {
  ...
  it('should truncate at sentence boundary when possible', () => {
    const text = 'This is the first sentence. This is the second sentence. This is the third sentence that goes on and on.';
