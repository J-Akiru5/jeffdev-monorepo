...
- **Semantic Search Tool**: MCP tool for searching context rules and transcripts
...
- **Stdio Transport**: Communication via stdin/stdout for editor integration
