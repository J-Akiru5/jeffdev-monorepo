...
| --------------------------- | --------------- | ----------------------------- | ------------------------------------------------------------------------------------ |
| `NEXT_PUBLIC_SUPABASE_URL`  | Yes             | —                             | Supabase project URL (same project as prism-engine)                                  |
| `SUPABASE_SERVICE_ROLE_KEY` | Yes             | —                             | Supabase service role key — reads/writes `prism_*` tables                            |
...
| `USE_GREMLIN_RANKING`       | No              | `false`                       | Enable rule-graph-based ranking (Postgres-backed, see docs/prism/PRISM_MIGRATION.md) |
