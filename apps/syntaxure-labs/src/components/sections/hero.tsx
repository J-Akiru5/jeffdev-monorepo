    ...
    <div className="relative z-10 drop-shadow-[0_15px_25px_rgba(6,182,212,0.15)] -mb-10">
      ...
      >
        ...
        {/* ═══════════════════════════════════════
            CENTER CONTENT
            ═══════════════════════════════════════ */}
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 lg:px-8 text-center py-24 lg:py-32">
          {/* ── Studio Badge ── */}
          <div
            ref={badgeRef}
          ...
          <h1
            ref={headlineRef}
            className={`text-4xl font-bold leading-[1.08] tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl transition-all duration-700 delay-100 ${
          ...
          {/* ── Neon Divider ── */}
          <div className="mx-auto mt-8 mb-6 w-24 h-px animate-border-beam" />

          {/* ── Subtext ── */}
          <p
            ref={subtextRef}
            className={`mx-auto max-w-2xl text-lg leading-relaxed text-white/50 md:text-xl transition-all duration-700 delay-200 ${
