      ...
      steps: [
        {
          ...
          popover: {
            title: "Who are you?",
            description:
              "Enter your full name as you want it to appear to clients and the team.",
            side: "bottom",
            align: "start",
          },
        },
        {
          ...
          popover: {
            title: "Your Role",
            description:
              "What is your official designation? (e.g., Senior Developer, Designer).",
            side: "bottom",
            align: "start",
          },
        },
        {
          ...
          popover: {
            title: "Contact Info",
            description:
              "Add your phone number for internal team communication.",
            side: "bottom",
            align: "start",
          },
        },
        {
          ...
          popover: {
            title: "Location",
            description:
              "Where are you based? Helps with time zone coordination.",
            side: "bottom",
            align: "start",
          },
        },
        ...
        },
        {
          ...
          popover: {
            ...
            description:
              "Choose a unique username for your public digital namecard.",
            side: "top",
            align: "start",
          },
        },
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-white/60 max-w-xl">
              Your profile is{" "}
              {Math.round(((6 - missingFields.length) / 6) * 100)}% complete.
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {missingFields.map((field) => (
                <span
                  key={field}
                  className="inline-flex items-center rounded-full border border-white/10 bg-black/40 px-2 py-1 text-[10px] text-white/50"
                >
