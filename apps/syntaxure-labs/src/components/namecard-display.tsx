  ...
  const generateVCard = () => {
    const vcard = [
      ...
      namecard.social?.linkedin
        ? `X-SOCIALPROFILE;type=linkedin:${namecard.social.linkedin}`
        : "",
      namecard.social?.github
        ? `X-SOCIALPROFILE;type=github:${namecard.social.github}`
        : "",
