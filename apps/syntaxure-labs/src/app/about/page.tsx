...
const DEFAULT_ABOUT_DATA: AboutData = {
  ...
  founder: {
    ...
    bio: "Full-stack engineer with 3+ years building production systems. Specializing in Next.js, cloud architecture, and AI integration. Previously worked on projects for education, e-commerce, and SaaS clients.",
    image: "/team/jeff.webp",
    email: "jeffmartinez@syntaxure.dev",
  ...
  founders: [
    {
      name: "Jeff Edrick Martinez",
      title: "CEO & Founder",
      bio: "Technical founder with 3+ years architecting production systems. Specializes in Next.js, cloud infrastructure, and AI integration for high-growth SaaS, e-commerce, and enterprise clients. Top 1% Developer Worldwide on CodersRank.",
      image: "/team/jeff.webp",
      email: "jeffmartinez@syntaxure.dev",
      location: "Iloilo City, Philippines",
    },
    {
      ...
      image: "/team/lou.webp",
      email: "loubaroro@syntaxure.dev",
      location: "Iloilo City, Philippines",
    },
    {
      name: "Hazel Dato-on",
      title: "COO | Head of Operations",
      bio: "Operations leader driving organizational efficiency and cross-functional coordination. Manages business processes, client relationships, and project delivery workflows to keep Syntaxure Labs running at scale.",
      image: "/team/hazel.webp",
      email: "hazeldato-on@isufst.edu.ph",
      location: "Iloilo City, Philippines",
    },
    {
      name: "Karl Calimotan",
      title: "CPO | UI/UX Architect",
      bio: "Product and design leader shaping user experiences across Syntaxure Labs platforms. Combines UI/UX architecture with applied AI to craft intuitive, high-performance interfaces for enterprise and SaaS products.",
      image: "/team/karl.webp",
      email: "karlcalimotan@isufst.edu.ph",
      location: "Iloilo City, Philippines",
    },
  ],
  team: [
    ...
    },
    {
      ...
      role: "COO",
      bio: "Managing operations, client relationships, and project delivery across all engagements.",
      image: "/team/hazel.webp",
    },
    {
      name: "Karl Calimotan",
      ...
      role: "CPO",
      bio: "Shaping product direction and UI/UX architecture across all Syntaxure platforms.",
      image: "/team/karl.webp",
    },
  ],
  techStack: {
