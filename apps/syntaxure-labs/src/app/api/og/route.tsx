...
export async function GET(req: NextRequest) {
  try {
    ...
    const title = searchParams.get('title') || 'Enterprise Systems Architecture';
      ...
      (
        ...
        >
          ...
          >
            ...
            {/* Main Headline */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: 'auto', marginBottom: '80px' }}>
              <h1
                style={{
                  fontSize: '80px',
                  lineHeight: '1.1',
              ...
              {description && (
                <p style={{ fontSize: '32px', color: '#ffffff', opacity: 0.7, margin: 0, maxWidth: '800px' }}>
                  {description}
                </p>
              )}
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'flex-end', marginTop: 'auto' }}>
              {/* Contact Information */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontFamily: 'monospace', fontSize: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <span style={{ color: '#ffffff', opacity: 0.8 }}>contact@jeffdev.studio</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center' }}>
