 ...
 */
export async function getPublicNamecard(
  username: string,
  ...
  try {
    ...
    const namecard: PublicNamecard = {
      ...
      social: {
        linkedin: user.namecard?.socials?.linkedin
          ? user.social?.linkedin
          : undefined,
        github: user.namecard?.socials?.github
          ? user.social?.github
          : undefined,
        twitter: user.namecard?.socials?.twitter
          ? user.social?.twitter
          : undefined,
        website: user.namecard?.socials?.website
          ? user.social?.website
          : undefined,
      },
...
export async function updateUserProfile(
  ...
  try {
    ...
    if (safeData.displayName !== undefined)
      updatePayload.full_name = safeData.displayName;
    if (safeData.photoURL !== undefined)
      updatePayload.avatar_url = safeData.photoURL;
    if (safeData.bio !== undefined) updatePayload.bio = safeData.bio;
    if (safeData.phone !== undefined) updatePayload.phone = safeData.phone;
    if (safeData.timezone !== undefined)
      updatePayload.timezone = safeData.timezone;
    ...
    if (safeData.assignedProjects !== undefined)
      newPrefs.assigned_projects = safeData.assignedProjects;
