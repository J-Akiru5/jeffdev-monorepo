        ...
        <section className="px-6 py-16 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose prose-invert mt-12 max-w-none prose-headings:font-semibold prose-headings:text-white prose-p:text-white/60 prose-strong:text-white prose-li:text-white/60">
              ...
              <p>
                Syntaxure Labs (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or
                &ldquo;us&rdquo;) is committed to protecting your privacy. This
                Privacy Policy explains how we collect, use, and safeguard your
                information when you visit our website jeffdev.studio (the
                &ldquo;Site&rdquo;).
              </p>
              ...
              <p>
                ...
                to us when you fill out a contact form, request a quote, or
                subscribe to our newsletter. This includes:
              </p>
              <ul>
                <li>Name</li>
                <li>Email address</li>
              ...
              <p>
                ...
                using cookies and similar tracking technologies. This includes:
              </p>
              <ul>
                <li>IP address</li>
              ...
              <h2>4. Cookies</h2>
              <p>
                We use cookies to track the activity on our Service and hold
              ...
              <ul>
                ...
                <li>
                  ...
                  measure performance and web vitals.
                </li>
              </ul>
