...
const config = {
  ...
  banner: {
    ...
    text: (
      ...
      >
        ...
        Prism Context Engine is currently in beta. Some features are still being
        refined.
      </span>
    ),
    dismissible: true,
  ...
  docsRepositoryBase:
    "https://github.com/J-Akiru5/jeffdev-monorepo/tree/main/apps/prism-docs",
  useNextSeoProps() {
    return {
  ...
  head: (
    <>
      ...
      <meta
        ...
        content="AI-powered context governance for LLMs - Currently in Beta"
      />
    </>
  ),
  primaryHue: 189, // Cyan
