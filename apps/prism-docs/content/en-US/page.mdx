...
#    Go to: https://prism.syntaxurelabs.com → Settings → API Keys → Generate Key
...
Prism Context Engine is part of the [Syntaxure Labs](https://syntaxurelabs.com) ecosystem — enterprise-grade tools for developers who want AI that respects their architecture.
