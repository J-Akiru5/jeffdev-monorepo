...
> **Prerequisites**: [Create a Prism account](https://prism.syntaxurelabs.com/sign-up) before starting.

## Your First Rule in 5 Minutes

### Step 1: Log In to Dashboard

Visit [prism.syntaxurelabs.com](https://prism.syntaxurelabs.com) and sign in.
...
<Cards>
  ...
  <Card title="Design System (Syntaxure Labs)" href="/rules/templates#jdstudio">
