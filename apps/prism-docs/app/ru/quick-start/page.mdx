...
<Cards>
  <Card title="Next.js App Router" href="/ru/rules/templates#nextjs">
    Server components, API routes, file conventions
  </Card>
  <Card title="React Best Practices" href="/ru/rules/templates#react">
    Hooks, component patterns, state management
  </Card>
  <Card title="Design System (Syntaxure Labs)" href="/ru/rules/templates#jdstudio">
    Dark mode, glass morphism, Tailwind tokens
  </Card>
  <Card title="Testing Strategy" href="/ru/rules/templates#testing">
...
[Learn more about Video Processing →](/ru/video/upload)
...
[Full MCP Setup Guide →](/ru/installation#option-b-mcp-server-advanced)
...
<Cards>
  <Card title="Creating Rules" href="/ru/rules/creating-rules">
    Learn rule syntax and best practices
  </Card>
  <Card title="IDE Integration" href="/ru/integrations/cursor">
    Connect Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Video Processing" href="/ru/video/upload">
