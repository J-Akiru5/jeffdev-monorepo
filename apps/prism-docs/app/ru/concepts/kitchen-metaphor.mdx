...
- [MCP Protocol Deep Dive](/ru/concepts/mcp-protocol) — Technical details of the "waiter"
- [Creating Rules](/ru/rules/creating-rules) — Write effective "recipes"
- [Video Processing](/ru/video/upload) — Automatic rule extraction
