...
- [Cursor Setup](/ru/integrations/cursor) — Full Cursor configuration
- [Windsurf Setup](/ru/integrations/windsurf) — Full Windsurf configuration
- [Troubleshooting MCP](/ru/troubleshooting/mcp-setup) — Fix common issues
