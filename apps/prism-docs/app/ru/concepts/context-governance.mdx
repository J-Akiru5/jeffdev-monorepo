...
- [Kitchen/Recipe/Waiter Metaphor](/ru/concepts/kitchen-metaphor) — Understand Prism's architecture model
- [MCP Protocol](/ru/concepts/mcp-protocol) — How rules reach your IDE
- [Creating Rules](/ru/rules/creating-rules) — Write effective context rules
