...
1. Create or generate rules (see [Creating Rules](/ru/rules/creating-rules))
...
[Full Cursor Setup Guide →](/ru/integrations/cursor)
...
[Full Windsurf Setup Guide →](/ru/integrations/windsurf)
...
[Full VS Code Setup Guide →](/ru/integrations/vscode)
...
[Full Claude Desktop Setup Guide →](/ru/integrations/claude-desktop)
...
<Callout type="error">
  **Connection Failed?** See [MCP Setup Troubleshooting](/ru/troubleshooting/mcp-setup)
</Callout>
...
- [Quick Start](/ru/quick-start) — Create your first rule
- [IDE Setup Guides](/ru/integrations/cursor) — Detailed configuration
- [Video Processing](/ru/video/upload) — Extract rules from recordings
