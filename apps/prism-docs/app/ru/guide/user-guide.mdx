...
<Cards>
  <Card title="Editor Setup" href="/ru/guide/editor-setup">
    Configure Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Creating Rules" href="/ru/guide/rules">
    Learn to write effective rules
  </Card>
  <Card title="MCP Integration" href="/ru/guide/mcp-integration">
