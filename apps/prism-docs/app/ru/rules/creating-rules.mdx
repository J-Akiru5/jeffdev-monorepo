...
- [Templates](/ru/rules/templates) — Start with pre-built templates
- [Exporting](/ru/rules/exporting) — Export rules for MCP/IDE
- [Design System Example](/ru/rules/design-system) — See a complete example
