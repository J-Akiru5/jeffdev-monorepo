...
- [Exporting Rules](/ru/rules/exporting) — Export to MCP/IDE
- [Creating Rules](/ru/rules/creating-rules) — Write custom rules
- [Design System Example](/ru/rules/design-system) — Complete example
