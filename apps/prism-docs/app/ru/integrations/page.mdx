...
<Cards>
  <Card title="Cursor" href="/ru/integrations/cursor">
    Configure Cursor with MCP and .cursorrules
  </Card>
  <Card title="Windsurf" href="/ru/integrations/windsurf">
    Set up Windsurf with MCP integration
  </Card>
  <Card title="VS Code" href="/ru/integrations/vscode">
    Install the MCP extension for VS Code
  </Card>
  <Card title="Claude Desktop" href="/ru/integrations/claude-desktop">
