...
> **New to Prism?** Start with [Quick Start](/ru/quick-start) to get up and running in 5 minutes.
...
<Cards>
  <Card title="Video-to-Context" href="/ru/video/upload">
    Upload screen recordings, get structured rules automatically
  </Card>
  <Card title="MCP Integration" href="/ru/integrations/cursor">
    Real-time sync with Cursor, Windsurf, VS Code, and Claude
  </Card>
  <Card title="Semantic Search" href="/ru/advanced/semantic-search">
    Find relevant architectural discussions using AI-powered search
  </Card>
  <Card title="Brand Profiles" href="/ru/advanced/brand-profiles">
...
<Cards>
  <Card title="Installation" href="/ru/installation">
    Set up your account and connect your IDE
  </Card>
  <Card title="Quick Start" href="/ru/quick-start">
