...
> **New to Prism?** Start with [Quick Start](/nl/quick-start) to get up and running in 5 minutes.
...
<Cards>
  <Card title="Video-to-Context" href="/nl/video/upload">
    Upload screen recordings, get structured rules automatically
  </Card>
  <Card title="MCP Integration" href="/nl/integrations/cursor">
    Real-time sync with Cursor, Windsurf, VS Code, and Claude
  </Card>
  <Card title="Semantic Search" href="/nl/advanced/semantic-search">
    Find relevant architectural discussions using AI-powered search
  </Card>
  <Card title="Brand Profiles" href="/nl/advanced/brand-profiles">
...
<Cards>
  <Card title="Installation" href="/nl/installation">
    Set up your account and connect your IDE
  </Card>
  <Card title="Quick Start" href="/nl/quick-start">
