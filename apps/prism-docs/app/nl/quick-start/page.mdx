...
<Cards>
  <Card title="Next.js App Router" href="/nl/rules/templates#nextjs">
    Server components, API routes, file conventions
  </Card>
  <Card title="React Best Practices" href="/nl/rules/templates#react">
    Hooks, component patterns, state management
  </Card>
  <Card title="Design System (Syntaxure Labs)" href="/nl/rules/templates#jdstudio">
    Dark mode, glass morphism, Tailwind tokens
  </Card>
  <Card title="Testing Strategy" href="/nl/rules/templates#testing">
...
[Learn more about Video Processing →](/nl/video/upload)
...
[Full MCP Setup Guide →](/nl/installation#option-b-mcp-server-advanced)
...
<Cards>
  <Card title="Creating Rules" href="/nl/rules/creating-rules">
    Learn rule syntax and best practices
  </Card>
  <Card title="IDE Integration" href="/nl/integrations/cursor">
    Connect Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Video Processing" href="/nl/video/upload">
