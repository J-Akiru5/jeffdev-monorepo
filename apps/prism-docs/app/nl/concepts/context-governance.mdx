...
- [Kitchen/Recipe/Waiter Metaphor](/nl/concepts/kitchen-metaphor) — Understand Prism's architecture model
- [MCP Protocol](/nl/concepts/mcp-protocol) — How rules reach your IDE
- [Creating Rules](/nl/rules/creating-rules) — Write effective context rules
