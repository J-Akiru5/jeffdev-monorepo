...
- [Cursor Setup](/nl/integrations/cursor) — Full Cursor configuration
- [Windsurf Setup](/nl/integrations/windsurf) — Full Windsurf configuration
- [Troubleshooting MCP](/nl/troubleshooting/mcp-setup) — Fix common issues
