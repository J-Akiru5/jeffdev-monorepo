...
<Cards>
  <Card title="Editor Setup" href="/nl/guide/editor-setup">
    Configure Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Creating Rules" href="/nl/guide/rules">
    Learn to write effective rules
  </Card>
  <Card title="MCP Integration" href="/nl/guide/mcp-integration">
