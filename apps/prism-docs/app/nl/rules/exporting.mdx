...
- [Cursor Setup](/nl/integrations/cursor) — Full Cursor integration
- [Windsurf Setup](/nl/integrations/windsurf) — Full Windsurf integration
- [MCP Protocol](/nl/concepts/mcp-protocol) — How MCP works
