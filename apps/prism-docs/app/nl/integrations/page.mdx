...
<Cards>
  <Card title="Cursor" href="/nl/integrations/cursor">
    Configure Cursor with MCP and .cursorrules
  </Card>
  <Card title="Windsurf" href="/nl/integrations/windsurf">
    Set up Windsurf with MCP integration
  </Card>
  <Card title="VS Code" href="/nl/integrations/vscode">
    Install the MCP extension for VS Code
  </Card>
  <Card title="Claude Desktop" href="/nl/integrations/claude-desktop">
