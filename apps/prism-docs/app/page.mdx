...
**Video-to-Context**: Developers hate writing docs. Prism allows you to upload a screen recording (via Mux), and the Engine "watches" it to learn your project's architectural rules automatically.
