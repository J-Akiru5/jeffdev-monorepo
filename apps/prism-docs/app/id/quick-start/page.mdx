...
<Cards>
  <Card title="Next.js App Router" href="/id/rules/templates#nextjs">
    Server components, API routes, file conventions
  </Card>
  <Card title="React Best Practices" href="/id/rules/templates#react">
    Hooks, component patterns, state management
  </Card>
  <Card title="Design System (Syntaxure Labs)" href="/id/rules/templates#jdstudio">
    Dark mode, glass morphism, Tailwind tokens
  </Card>
  <Card title="Testing Strategy" href="/id/rules/templates#testing">
...
[Learn more about Video Processing →](/id/video/upload)
...
[Full MCP Setup Guide →](/id/installation#option-b-mcp-server-advanced)
...
<Cards>
  <Card title="Creating Rules" href="/id/rules/creating-rules">
    Learn rule syntax and best practices
  </Card>
  <Card title="IDE Integration" href="/id/integrations/cursor">
    Connect Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Video Processing" href="/id/video/upload">
