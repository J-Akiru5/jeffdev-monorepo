...
- [Exporting Rules](/id/rules/exporting) — Export to MCP/IDE
- [Creating Rules](/id/rules/creating-rules) — Write custom rules
- [Design System Example](/id/rules/design-system) — Complete example
