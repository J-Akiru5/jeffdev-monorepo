...
- [Templates](/id/rules/templates) — Start with pre-built templates
- [Exporting](/id/rules/exporting) — Export rules for MCP/IDE
- [Design System Example](/id/rules/design-system) — See a complete example
