...
<Cards>
  <Card title="Cursor" href="/id/integrations/cursor">
    Configure Cursor with MCP and .cursorrules
  </Card>
  <Card title="Windsurf" href="/id/integrations/windsurf">
    Set up Windsurf with MCP integration
  </Card>
  <Card title="VS Code" href="/id/integrations/vscode">
    Install the MCP extension for VS Code
  </Card>
  <Card title="Claude Desktop" href="/id/integrations/claude-desktop">
