...
- [Cursor Setup](/id/integrations/cursor) — Full Cursor configuration
- [Windsurf Setup](/id/integrations/windsurf) — Full Windsurf configuration
- [Troubleshooting MCP](/id/troubleshooting/mcp-setup) — Fix common issues
