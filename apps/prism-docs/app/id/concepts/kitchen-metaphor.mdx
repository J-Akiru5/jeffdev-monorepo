...
- [MCP Protocol Deep Dive](/id/concepts/mcp-protocol) — Technical details of the "waiter"
- [Creating Rules](/id/rules/creating-rules) — Write effective "recipes"
- [Video Processing](/id/video/upload) — Automatic rule extraction
