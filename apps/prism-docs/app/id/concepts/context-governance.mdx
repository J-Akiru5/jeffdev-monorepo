...
- [Kitchen/Recipe/Waiter Metaphor](/id/concepts/kitchen-metaphor) — Understand Prism's architecture model
- [MCP Protocol](/id/concepts/mcp-protocol) — How rules reach your IDE
- [Creating Rules](/id/rules/creating-rules) — Write effective context rules
