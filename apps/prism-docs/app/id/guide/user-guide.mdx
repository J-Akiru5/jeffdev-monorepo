...
<Cards>
  <Card title="Editor Setup" href="/id/guide/editor-setup">
    Configure Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Creating Rules" href="/id/guide/rules">
    Learn to write effective rules
  </Card>
  <Card title="MCP Integration" href="/id/guide/mcp-integration">
