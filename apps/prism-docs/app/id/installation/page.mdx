...
1. Create or generate rules (see [Creating Rules](/id/rules/creating-rules))
...
[Full Cursor Setup Guide →](/id/integrations/cursor)
...
[Full Windsurf Setup Guide →](/id/integrations/windsurf)
...
[Full VS Code Setup Guide →](/id/integrations/vscode)
...
[Full Claude Desktop Setup Guide →](/id/integrations/claude-desktop)
...
<Callout type="error">
  **Connection Failed?** See [MCP Setup Troubleshooting](/id/troubleshooting/mcp-setup)
</Callout>
...
- [Quick Start](/id/quick-start) — Create your first rule
- [IDE Setup Guides](/id/integrations/cursor) — Detailed configuration
- [Video Processing](/id/video/upload) — Extract rules from recordings
