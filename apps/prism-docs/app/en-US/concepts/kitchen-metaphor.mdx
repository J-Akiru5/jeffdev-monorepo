...
The **Kitchen** is where all preparation happens — it's the Prism web dashboard at [prism.syntaxurelabs.com](https://prism.syntaxurelabs.com).
...
- [MCP Protocol Deep Dive](/concepts/mcp-protocol) — Technical details of the "waiter"
- [Creating Rules](/rules/creating-rules) — Write effective "recipes"
- [Video Processing](/video/upload) — Automatic rule extraction
