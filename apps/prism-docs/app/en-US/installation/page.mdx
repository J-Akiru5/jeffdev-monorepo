...
> **Fastest Path**: Use the [Web Dashboard](https://prism.syntaxurelabs.com) — no installation required for basic usage.
...
1. Visit [prism.syntaxurelabs.com/sign-up](https://prism.syntaxurelabs.com/sign-up)
...
Navigate to [prism.syntaxurelabs.com/settings](https://prism.syntaxurelabs.com/settings)
...
```json
{
  "mcpServers": {
    "prism": {
      "command": "prism-mcp",
      "env": {
        "PRISM_API_KEY": "pk_live_your_api_key_here",
...
| `PRISM_API_URL` | No | Dashboard URL (default: `https://prism.syntaxurelabs.com`) |
