...
- [Cursor Setup](/integrations/cursor) — Full Cursor configuration
- [Windsurf Setup](/integrations/windsurf) — Full Windsurf configuration
- [Troubleshooting MCP](/troubleshooting/mcp-setup) — Fix common issues
