...
Upload screen recordings to automatically extract architectural rules.

**Uploading a Video:**
1. Navigate to a project detail page
2. Scroll to the **"Video Context"** section
3. Click **"Upload Context Video"**
4. Select your video file (MP4, MOV, WEBM up to 500MB)
5. The video uploads to Mux for processing
6. Azure OpenAI processes the transcript to generate rules
7. Rules appear in your project when processing completes

**Best Practices:**
- Record yourself explaining your architecture or design decisions
- Keep videos under 10 minutes for best results
- Speak clearly about patterns and constraints
- The AI extracts rules based on your explanations
