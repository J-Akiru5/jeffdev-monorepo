...
<Cards>
  <Card title="Cursor" href="/en-GB/integrations/cursor">
    Configure Cursor with MCP and .cursorrules
  </Card>
  <Card title="Windsurf" href="/en-GB/integrations/windsurf">
    Set up Windsurf with MCP integration
  </Card>
  <Card title="VS Code" href="/en-GB/integrations/vscode">
    Install the MCP extension for VS Code
  </Card>
  <Card title="Claude Desktop" href="/en-GB/integrations/claude-desktop">
