...
- [Cursor Setup](/en-GB/integrations/cursor) — Full Cursor configuration
- [Windsurf Setup](/en-GB/integrations/windsurf) — Full Windsurf configuration
- [Troubleshooting MCP](/en-GB/troubleshooting/mcp-setup) — Fix common issues
