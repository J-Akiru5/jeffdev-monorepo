...
- [Kitchen/Recipe/Waiter Metaphor](/en-GB/concepts/kitchen-metaphor) — Understand Prism's architecture model
- [MCP Protocol](/en-GB/concepts/mcp-protocol) — How rules reach your IDE
- [Creating Rules](/en-GB/rules/creating-rules) — Write effective context rules
