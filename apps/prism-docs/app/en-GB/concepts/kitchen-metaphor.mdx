...
- [MCP Protocol Deep Dive](/en-GB/concepts/mcp-protocol) — Technical details of the "waiter"
- [Creating Rules](/en-GB/rules/creating-rules) — Write effective "recipes"
- [Video Processing](/en-GB/video/upload) — Automatic rule extraction
