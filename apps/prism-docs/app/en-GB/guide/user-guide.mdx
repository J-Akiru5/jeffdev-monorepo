...
1. Navigate to your Prism Dashboard URL (e.g., `https://prism.syntaxure.dev`)
...
npx prism-context-engine <command>
```
...
<Cards>
  <Card title="Editor Setup" href="/en-GB/guide/editor-setup">
    Configure Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Creating Rules" href="/en-GB/guide/rules">
    Learn to write effective rules
  </Card>
  <Card title="MCP Integration" href="/en-GB/guide/mcp-integration">
