...
| IDE | Status | Protocol |
|-----|--------|----------|
| **Cursor** | ✅ Supported | MCP via stdio |
| **Windsurf** | ✅ Supported | MCP via stdio |
| **Claude Desktop** | ✅ Supported | MCP via stdio |
| **VS Code + Continue** | 🔄 Coming Soon | MCP via HTTP |
...
**🆕 NEW:** Semantically search through video transcripts using AI embeddings.
...
See [Semantic Search Guide](/en-GB/guide/semantic-search) for details on how vector search works.
