...
npx prism-context-engine generate --template nextjs --style jdstudio

# List all available templates
npx prism-context-engine list-templates

# Interactive mode
npx prism-context-engine
```
...
- **Dashboard**: Web-based SaaS at https://prism.syntaxure.dev (no local installation required)
...
1. Sign up at https://prism.syntaxure.dev
...
# Show version
npx prism-context-engine --version
```
