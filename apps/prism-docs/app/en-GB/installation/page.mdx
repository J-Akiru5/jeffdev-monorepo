...
> **Fastest Path**: Use the [Web Dashboard](https://prism.syntaxure.dev) — no installation required for basic usage.
...
1. Visit [prism.syntaxure.dev/sign-up](https://prism.syntaxure.dev/sign-up)
...
Navigate to [prism.syntaxure.dev/settings](https://prism.syntaxure.dev/settings)
