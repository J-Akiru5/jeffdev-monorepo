...
- [Exporting Rules](/en-GB/rules/exporting) — Export to MCP/IDE
- [Creating Rules](/en-GB/rules/creating-rules) — Write custom rules
- [Design System Example](/en-GB/rules/design-system) — Complete example
