  ...
  sync:
    ...
    steps:
      ...
      - name: Install Prism CLI
        run: npm install -g prism-context-engine
...
- [Cursor Setup](/en-GB/integrations/cursor) — Full Cursor integration
- [Windsurf Setup](/en-GB/integrations/windsurf) — Full Windsurf integration
- [MCP Protocol](/en-GB/concepts/mcp-protocol) — How MCP works
