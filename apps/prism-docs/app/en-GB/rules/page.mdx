...
<Cards>
  ...
  <Card title="Rule Templates" href="/en-GB/rules/templates">
    Start with pre-built templates for common stacks
  </Card>
  <Card title="Exporting Rules" href="/en-GB/rules/exporting">
    Export to .cursorrules, .windsurfrules, and more
  </Card>
  <Card title="Security Rules" href="/en-GB/rules/security">
