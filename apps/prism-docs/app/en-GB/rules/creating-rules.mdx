...
- [Templates](/en-GB/rules/templates) — Start with pre-built templates
- [Exporting](/en-GB/rules/exporting) — Export rules for MCP/IDE
- [Design System Example](/en-GB/rules/design-system) — See a complete example
