...
> **New to Prism?** Start with [Quick Start](/en-GB/quick-start) to get up and running in 5 minutes.
...
<Cards>
  <Card title="Video-to-Context" href="/en-GB/video/upload">
    Upload screen recordings, get structured rules automatically
  </Card>
  <Card title="MCP Integration" href="/en-GB/integrations/cursor">
    Real-time sync with Cursor, Windsurf, VS Code, and Claude
  </Card>
  <Card title="Semantic Search" href="/en-GB/advanced/semantic-search">
    Find relevant architectural discussions using AI-powered search
  </Card>
  <Card title="Brand Profiles" href="/en-GB/advanced/brand-profiles">
...
<Cards>
  <Card title="Installation" href="/en-GB/installation">
    Set up your account and connect your IDE
  </Card>
  <Card title="Quick Start" href="/en-GB/quick-start">
