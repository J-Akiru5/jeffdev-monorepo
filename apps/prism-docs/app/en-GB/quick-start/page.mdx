...
<Cards>
  <Card title="Next.js App Router" href="/en-GB/rules/templates#nextjs">
    Server components, API routes, file conventions
  </Card>
  <Card title="React Best Practices" href="/en-GB/rules/templates#react">
    Hooks, component patterns, state management
  </Card>
  <Card title="Design System (Syntaxure Labs)" href="/en-GB/rules/templates#jdstudio">
    Dark mode, glass morphism, Tailwind tokens
  </Card>
  <Card title="Testing Strategy" href="/en-GB/rules/templates#testing">
...
[Learn more about Video Processing →](/en-GB/video/upload)
...
[Full MCP Setup Guide →](/en-GB/installation#option-b-mcp-server-advanced)
...
<Cards>
  <Card title="Creating Rules" href="/en-GB/rules/creating-rules">
    Learn rule syntax and best practices
  </Card>
  <Card title="IDE Integration" href="/en-GB/integrations/cursor">
    Connect Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Video Processing" href="/en-GB/video/upload">
