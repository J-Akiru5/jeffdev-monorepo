...
<Cards>
  <Card title="Cursor" href="/es/integrations/cursor">
    Configure Cursor with MCP and .cursorrules
  </Card>
  <Card title="Windsurf" href="/es/integrations/windsurf">
    Set up Windsurf with MCP integration
  </Card>
  <Card title="VS Code" href="/es/integrations/vscode">
    Install the MCP extension for VS Code
  </Card>
  <Card title="Claude Desktop" href="/es/integrations/claude-desktop">
