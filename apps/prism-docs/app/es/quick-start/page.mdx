...
<Cards>
  <Card title="Next.js App Router" href="/es/rules/templates#nextjs">
    Server components, API routes, file conventions
  </Card>
  <Card title="React Best Practices" href="/es/rules/templates#react">
    Hooks, component patterns, state management
  </Card>
  <Card title="Design System (Syntaxure Labs)" href="/es/rules/templates#jdstudio">
    Dark mode, glass morphism, Tailwind tokens
  </Card>
  <Card title="Testing Strategy" href="/es/rules/templates#testing">
...
[Learn more about Video Processing →](/es/video/upload)
...
[Full MCP Setup Guide →](/es/installation#option-b-mcp-server-advanced)
...
<Cards>
  <Card title="Creating Rules" href="/es/rules/creating-rules">
    Learn rule syntax and best practices
  </Card>
  <Card title="IDE Integration" href="/es/integrations/cursor">
    Connect Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Video Processing" href="/es/video/upload">
