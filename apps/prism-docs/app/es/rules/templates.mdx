...
- [Exporting Rules](/es/rules/exporting) — Export to MCP/IDE
- [Creating Rules](/es/rules/creating-rules) — Write custom rules
- [Design System Example](/es/rules/design-system) — Complete example
