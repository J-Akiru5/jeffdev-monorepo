...
- [Templates](/es/rules/templates) — Start with pre-built templates
- [Exporting](/es/rules/exporting) — Export rules for MCP/IDE
- [Design System Example](/es/rules/design-system) — See a complete example
