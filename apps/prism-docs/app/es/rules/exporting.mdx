...
- [Cursor Setup](/es/integrations/cursor) — Full Cursor integration
- [Windsurf Setup](/es/integrations/windsurf) — Full Windsurf integration
- [MCP Protocol](/es/concepts/mcp-protocol) — How MCP works
