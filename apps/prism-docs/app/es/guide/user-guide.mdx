...
<Cards>
  <Card title="Editor Setup" href="/es/guide/editor-setup">
    Configure Cursor, Windsurf, or VS Code
  </Card>
  <Card title="Creating Rules" href="/es/guide/rules">
    Learn to write effective rules
  </Card>
  <Card title="MCP Integration" href="/es/guide/mcp-integration">
