...
1. Create or generate rules (see [Creating Rules](/es/rules/creating-rules))
...
[Full Cursor Setup Guide →](/es/integrations/cursor)
...
[Full Windsurf Setup Guide →](/es/integrations/windsurf)
...
[Full VS Code Setup Guide →](/es/integrations/vscode)
...
[Full Claude Desktop Setup Guide →](/es/integrations/claude-desktop)
...
<Callout type="error">
  **Connection Failed?** See [MCP Setup Troubleshooting](/es/troubleshooting/mcp-setup)
</Callout>
...
- [Quick Start](/es/quick-start) — Create your first rule
- [IDE Setup Guides](/es/integrations/cursor) — Detailed configuration
- [Video Processing](/es/video/upload) — Extract rules from recordings
