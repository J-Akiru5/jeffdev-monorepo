...
- [Kitchen/Recipe/Waiter Metaphor](/es/concepts/kitchen-metaphor) — Understand Prism's architecture model
- [MCP Protocol](/es/concepts/mcp-protocol) — How rules reach your IDE
- [Creating Rules](/es/rules/creating-rules) — Write effective context rules
