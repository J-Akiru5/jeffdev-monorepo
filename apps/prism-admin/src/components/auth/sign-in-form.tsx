    ...
    <div className="w-full max-w-sm mx-auto">
      ...
      <div className="space-y-2.5 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-md border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium text-white/70 hover:text-white"
        >
          {oauthLoading === "google" ? (
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-[#030303] px-3 text-white/30">Or continue with email</span>
        </div>
      </div>
