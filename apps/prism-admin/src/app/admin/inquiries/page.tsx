      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-white/50">
            Client messages from contact forms
          </p>
        </div>
        ...
        {inquiries.length > 0 ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-xs text-white/40 max-w-sm mx-auto">
              Client inquiries from contact forms will appear here. Connect Zoho
              Mail to start receiving messages.
            </p>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/50 mt-1">
              Configure Zoho Mail API credentials in Doppler to enable inbox
              sync. Responses will be sent via Resend API.
            </p>
          </div>
        </div>
      </div>
