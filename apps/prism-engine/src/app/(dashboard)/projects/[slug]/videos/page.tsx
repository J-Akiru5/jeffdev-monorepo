...
import { GlassPanel } from "@syntaxure/ui";
...
/**
 * Video Library Page
 * Lists processed video transcripts from the database.
 */
    ...
    <div className="space-y-8">
      ...
      {videos.length === 0 ? (
        <GlassPanel className="p-12 text-center">
          ...
          <p className="text-white/50">No videos processed yet.</p>
          <p className="text-sm text-white/30 mt-1">
            Upload a video through the project page to extract rules automatically.
          </p>
          <Link
            href={`/projects/${slug}`}
