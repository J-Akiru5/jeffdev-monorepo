...
export const metadata = {
  ...
  description:
    "Terms of Service for Prism Context Engine - the context governance platform for developers.",
};
          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-8">
            ...
            <section className="rounded-lg border border-white/10 bg-white/2 p-6">
              ...
              <ul className="list-disc list-inside text-white/70 space-y-2">
                ...
                <li>
                  Upgrades take effect immediately; downgrades apply at the next
                  billing cycle
                </li>
                <li>
                  Prices are displayed in Philippine Pesos (₱) unless otherwise
                  specified
                </li>
              </ul>
            ...
            <section className="rounded-lg border border-white/10 bg-white/2 p-6">
              ...
              <ul className="list-disc list-inside text-white/70 space-y-2">
                ...
                <li>
                  Exceed your tier&apos;s usage limits through automated means
                </li>
                <li>
