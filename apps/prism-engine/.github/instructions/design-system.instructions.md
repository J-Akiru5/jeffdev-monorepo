...
- **Dashboard (Phase 1):** `apps/prism-dashboard` (Next.js 16) - _Do not touch this unless necessary._
...
- **Mux Integration:** We do NOT process video. We only query the _text transcript_ that was already saved to the DB by Phase 1.
