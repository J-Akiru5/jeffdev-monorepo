...
import { listRules, createRule, editRule, deleteRule } from './commands/rules.js';
import { connect } from './commands/connect.js';
import { init } from './commands/init.js';
import { listProjects, viewProject, createProject, deleteProject } from './commands/projects.js';
import { listBrands, viewBrand, createBrand, exportBrand, deleteBrand } from './commands/brands.js';
...
brandsCmd
  ...
  .option('-f, --format <format>', 'Export format: cursor|windsurf|vscode|claude|css|tailwind', 'cursor')
