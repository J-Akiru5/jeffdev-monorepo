...
Admin data is _always_ dynamic. Do not let Next.js cache the Dashboard.
...
| _(Plus: invites, quotes, subscriptions, calendar_events)_ |                         |                                 |
...
3. **Claims:** Use Firebase Custom Claims for _edge_ protection (Middleware), but Firestore Data for _app_ logic.
